      ...
      <main style={{ flex: 1, padding: "40px", display: "flex", justifyContent: "center", alignItems: "center" }}>
        <div className="glass" style={{ width: "100%", maxWidth: "800px", padding: "40px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "16px", color: "#A39FB8", margin: "0 0 32px 0", lineHeight: "1.6" }}>
            This AI agent is scaffolded with full Django + Vite + Ollama capability. Its OIDC SSO authentication, database connection, platform worker loops, and local VLM integration are active.
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "20px", marginTop: "24px" }}>
            ...
            <div className="glass" style={{ padding: "20px" }}>
              ...
              <p style={{ margin: 0, fontSize: "16px", color: "#F4F2FF" }}>example (local qwen2.5-vl)</p>
            </div>
            <div className="glass" style={{ padding: "20px" }}>
              <h3 style={{ margin: "0 0 8px 0", color: "#7C5CFF" }}>Local AI</h3>
              <p style={{ margin: 0, fontSize: "16px", color: "#F4F2FF" }}>Ollama (CPU/GPU)</p>
            </div>
          </div>
        </div>
      </main>
